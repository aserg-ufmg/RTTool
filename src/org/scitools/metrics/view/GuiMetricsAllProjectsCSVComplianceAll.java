 ...
 * @author fernando
 */
public class GuiMetricsAllProjectsCSVComplianceAll extends javax.swing.JFrame implements PropertyChangeListener {
    ...
    class Task extends SwingWorker<Void, Void> {
        ...
        public Void doInBackground() {
            ...
            jLabel3.setText("Number of files: " + qtd);
            for (String x : filesNames) {
                jLabel2.setText("File in course: " + x);
                gafc.geraCompilances(pathOrigem, jTextField1.getText(), x, jSlider2.getValue(), jSlider1.getValue(), 0, 0);
    ...
    public GuiMetricsAllProjectsCSVComplianceAll() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GuiMetricsAllProjectsCSVComplianceAll.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GuiMetricsAllProjectsCSVComplianceAll().setVisible(true);
            }
        });
